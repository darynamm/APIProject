...
import api.controller.Controller; //Change me
import api.view.ActivityPanel; //Change me
import javax.swing.*;
...
public class PanelTest
{
	...
	private ActivityPanel testedPanel; //Change me

	@BeforeEach
	void setUp() throws Exception
	{
		this.testedController = new Controller(); //Change me
		this.testedPanel = new ActivityPanel(testedController); //Change me
	} 
	...
	void testPanelComponents()
	{
		...
		assertTrue(fields.length > 2, "You need at least 3 data members in your ActivityPanel");
